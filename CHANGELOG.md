...
| 2026-04-19 | 0.4.2 | MDエクスポートの見出しをtimestampではなくdate列から生成するよう修正 |
| 2026-04-19 | 0.4.1 | ListPageにジャンル・期間絞り込みとマークダウン形式のコピー/ダウンロード機能を追加 |
| 2026-04-19 | 0.4.0 | ジャンル対応として開発・学習、筋トレ、日記のsheet・列・タグ・入力フォーム・一覧表示切替をReact側に実装し、log-format.mdを更新 |
| 2026-04-19 | 0.3.0 | 手動作業ゼロ設計をAGENTS.mdとspec.mdへ明記し、GASを汎用GET受け口、sheet・headers・valuesをReact側で組み立てる構成へ変更 |
